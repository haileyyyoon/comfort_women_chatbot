...
def _answer_instructions(language: str) -> str:
    ...
    return (
        ...
        "with one to three short follow-up suggestions, separated from the paragraph "
        "by exactly one blank line and each on its own line, phrased as warm, "
        "inviting questions the visitor could ask next "

...
def _answer_instructions(language: str) -> str:
    ...
    return (
        ...
        "In Korean use '할머니들' or '피해자 할머니들' and NEVER '그녀들' or '그들' — "
        "if you are about to write '그들' or '그녀들' for the survivors, write "
        "'할머니들' (or '피해자들') instead, e.g. not '그들이 겪은 일' but "
        "'할머니들이 겪은 일'. "

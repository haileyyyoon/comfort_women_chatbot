...
def _answer_instructions(language: str) -> str:
    ...
    return (
        ...
        "on EVERY mention, including inside lists. Refer to survivors from other "
        "countries with equal respect (for example 'Grandmother [Name]' or 'the "
        "survivor [Name]'). Never attach any such honorific to non-victims such as "
        "government officials, soldiers, or perpetrators.\n"
